...
$NDK_DIR/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --sysroot=$NDK_DIR/platforms/android-21/arch-arm/ -shared  -fPIC -DPIC  client/.libs/client.o   common/libcommon.a -llog  --sysroot=$NDK_DIR/platforms/android-21/arch-arm/ -O2   -Wl,-soname -Wl,libclient.so -o client/.libs/libclient.so.0.0.0
